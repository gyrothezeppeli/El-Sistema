...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F4F0] via-[#E8D5C4] to-[#D4B8A4]">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            <div className="flex items-center space-x-2 md:space-x-3 flex-1">
              <span className="text-white text-xs sm:text-sm md:text-xl font-bold truncate">
      ...
      <section 
        className="relative py-16 md:py-32 text-white overflow-hidden min-h-[500px] md:min-h-screen flex items-center"
        style={{
