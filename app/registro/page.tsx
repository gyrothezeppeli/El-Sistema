...
import { Eye, EyeOff, UserPlus, User, Mail, Lock, AlertCircle, CheckCircle2, IdCard } from 'lucide-react'
    ...
    <Card className="w-full max-w-2xl mx-auto shadow-2xl border-[#D9C7A8]">
      <CardHeader className="space-y-1 text-center pb-6 bg-gradient-to-r from-[#795C34] to-[#65350F] text-white rounded-t-lg">
        ...
        <CardDescription className="text-lg text-[#E8DFD1]">
          Regístrate en el sistema de gestión estudiantil
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6 bg-[#FDF8F3] p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Campo Rol */}
          <div className="space-y-3">
            <Label htmlFor="rol" className="text-sm font-medium text-[#362511]">
              Usuario
            </Label>
            <select
              id="rol"
              ...
              disabled={isLoading}
              className="w-full h-12 px-3 text-base border border-[#D9C7A8] rounded-md focus:border-[#795C34] focus:ring-1 focus:ring-[#795C34] bg-white text-[#362511]"
            >
