...
function HomeContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F4F0] via-[#E8D5C4] to-[#D4B8A4]">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center space-x-3 flex-1">
              <span className="text-white text-sm md:text-xl font-bold line-clamp-2">
      ...
      {/* Modal de Selección de Inscripción - responsive */}
      <Dialog open={showRegistrationModal} onOpenChange={setShowRegistrationModal}>
        <DialogContent className="max-w-[95%] md:max-w-[1000px] mx-auto p-0 overflow-hidden border-[#9A784F] shadow-2xl rounded-lg md:rounded-xl">
          ...
          <div className="relative bg-gradient-to-r from-[#795C34] to-[#65350F] p-6 md:p-8 text-white">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="absolute right-4 top-4 md:right-6 md:top-6 text-white hover:bg-white/20 w-8 h-8 md:w-10 md:h-10 transition-colors duration-200"
          ...
          <div className="p-6 md:p-10 max-h-[70vh] md:max-h-[60vh] overflow-y-auto bg-white">
                ...
                <CardContent className="flex-grow flex flex-col justify-between">
                  <div className="space-y-3 md:space-y-4 text-base md:text-lg text-[#362511] mb-6 md:mb-8 font-medium">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-left text-sm md:text-base">Información personal del estudiante</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 md:w-3 md:h-3 bg-[#9A784F] rounded-full flex-shrink-0"></div>
                      <span className="text-left text-sm md:text-base">Datos académicos y musicales</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 md:w-3 md:h-3 bg-[#9A784F] rounded-full flex-shrink-0"></div>
                      <span className="text-left text-sm md:text-base">Información de salud</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 md:w-3 md:h-3 bg-[#9A784F] rounded-full flex-shrink-0"></div>
                      <span className="text-left text-sm md:text-base">Continúa con representantes después</span>
                    </div>
                  </div>
                  <Button className="w-full bg-[#9A784F] hover:bg-[#795C34] text-base md:text-xl py-3 md:py-6 h-auto font-bold text-white shadow-lg transition-colors duration-200">
      ...
      <section 
        className="relative py-16 md:py-32 text-white overflow-hidden min-h-[600px] md:min-h-screen flex items-center"
        style={{
      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-2xl md:text-6xl lg:text-7xl font-bold mb-3 md:mb-6 text-[#F8F4F0] drop-shadow-lg px-2">
              Sistema Integral de Gestión de Prácticas Musicales
            </h1>
            <div className="text-lg md:text-2xl lg:text-3xl mb-4 md:mb-8 text-white font-light space-y-1 md:space-y-2">
              <p>Música</p>
              <p>Cultura</p>
              <p>Arte</p>
            </div>
            <p className="text-base md:text-xl lg:text-2xl mb-6 md:mb-12 text-[#E8D5C4] font-medium px-4">
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#362511] mb-3 md:mb-4 drop-shadow-sm px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
            ...
            <Card className="text-center hover:shadow-2xl transition-all duration-300 border-2 border-[#E8D5C4] shadow-lg hover:scale-105 min-h-[350px] md:min-h-[400px] flex flex-col bg-white">
              <CardHeader className="pb-4 md:pb-6 flex-shrink-0">
                ...
                <CardDescription className="text-base md:text-xl text-[#65350F] font-medium px-2">
          ...
          {/* Sección de Tabla de Estudiantes - responsive */}
          {isAdmin && (
            <div className="max-w-4xl mx-auto mt-12 md:mt-16 text-center px-4">
              <Card className="border-2 border-[#65350F] bg-[#F8F4F0] min-h-[180px] md:min-h-[200px] flex flex-col justify-center shadow-lg">
                ...
                <CardContent>
                  <Link href="/tabla">
                    <Button className="bg-[#65350F] hover:bg-[#362511] text-white text-base md:text-lg py-3 md:py-4 px-8 md:px-12 font-bold shadow-lg transition-colors duration-200">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-12 text-[#F8F4F0] drop-shadow-lg px-2">
            ...
            <div className="text-sm md:text-xl lg:text-2xl leading-relaxed space-y-4 md:space-y-8 text-left bg-white/10 backdrop-blur-sm rounded-xl md:rounded-3xl p-4 md:p-12">
              ...
              <blockquote className="italic border-l-4 border-[#F8F4F0] pl-3 md:pl-8 my-6 md:my-12 text-base md:text-2xl text-[#F8F4F0] text-center font-medium">
                &quot;La música es un instrumento irremplazable para unir a las personas.&quot;
                <footer className="mt-2 md:mt-4 text-white text-sm md:text-xl">- José Antonio Abreu</footer>
              </blockquote>
      ...
      {/* Footer - responsive */}
      <footer className="bg-[#362511] text-white py-8 md:py-16 border-t border-[#795C34]">
        <div className="container mx-auto px-4">
          <div className="border-t border-[#795C34] mt-6 md:mt-12 pt-4 md:pt-8 text-center text-[#D4B8A4]">
