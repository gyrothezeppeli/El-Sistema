...
export default function InicioPage() {
  const partituras: Ejercicio[] = [
    {
      ...
      enlace: "https://drive.google.com/file/d/19MyGX-tDSwpGAJ3858u_rBSc-TpE4blc/view?usp=drive_link",
    },
    {
      id: 2,
      titulo: "Venezuela",
  ...
  const ejerciciosContrabajo: Ejercicio[] = [
    {
      id: 1,
      titulo: "Violin",
      enlace: "https://youtu.be/cM_84VSbqj4?si=dTDEo5nxrSngTTkZ",
    },
    {
      id: 2,
      titulo: "Arpegios Posiciones",
      enlace: "https://drive.google.com/file/d/1tA8dayNLfHLX1SUvP-V2nPN3sZpC9Edt/view?usp=drive_link",
    },
    {
      id: 3,
      titulo: "Técnica de Arco",
      enlace: "#",
    },
    {
      id: 4,
      titulo: "Ejercicios Ritmo",
      enlace: "#",
    },
    {
      id: 5,
    ...
    {
      id: 8,
      titulo: "Técnica Pizzicato",
      enlace: "#",
    },
    {
      id: 9,
      titulo: "Estudios Bottesini",
      enlace: "#",
    },
    {
      id: 10,
      titulo: "Ejercicios Armónicos",
      enlace: "#",
    }
  ]

  const ejerciciosViolin1: Ejercicio[] = [
    {
      id: 1,
      titulo: "Escalas Básicas Violín 1",
      enlace: "https://youtu.be/example_violin1_scales",
    },
    {
      id: 2,
      titulo: "Arpegios Posiciones",
      enlace: "https://drive.google.com/file/d/1example_violin1_arpeggios/view?usp=drive_link",
    },
    {
      id: 3,
      titulo: "Técnica de Arco Violín",
      enlace: "#",
    },
    {
      id: 4,
      titulo: "Ejercicios Ritmo Violín 1",
      enlace: "#",
    },
    {
      id: 5,
    ...
    {
      id: 8,
      titulo: "Técnica Staccato",
      enlace: "#",
    },
    {
      id: 9,
      titulo: "Estudios Rode",
      enlace: "#",
    },
    {
      id: 10,
      titulo: "Ejercicios Velocidad",
      enlace: "#",
    }
  ]

  const ejerciciosViolonchelo: Ejercicio[] = [
    {
      id: 1,
      titulo: "Escalas Básicas Violonchelo",
      enlace: "https://youtu.be/example_cello_scales",
    },
    {
      id: 2,
      titulo: "Arpegios Posiciones",
      enlace: "https://drive.google.com/file/d/1example_cello_arpeggios/view?usp=drive_link",
    },
    {
      id: 3,
      titulo: "Técnica de Arco Cello",
      enlace: "#",
    },
    {
      id: 4,
      titulo: "Ejercicios Ritmo Cello",
      enlace: "#",
    },
    {
      id: 5,
    ...
    {
      id: 8,
      titulo: "Técnica Thumb Position",
      enlace: "#",
    },
    {
      id: 9,
      titulo: "Estudios Popper",
      enlace: "#",
    },
    {
      id: 10,
      titulo: "Ejercicios Expresivos",
      enlace: "#",
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F4F0] via-[#E8D5C4] to-[#D4B8A4]">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {renderEjerciciosSection('Violín 1', ejerciciosViolin1)}
